...
export const NewsletterModal: React.FC<NewsletterModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 animate-fadeIn">
      <div className="bg-white dark:bg-dark-surface rounded-xl p-6 max-w-md w-full relative animate-slideUp">
        <button
          onClick={onClose}
        ...
        {status === 'success' ? (
          <div className="text-center space-y-4 animate-fadeIn">
            ...
            <p className="text-green-600 dark:text-green-400">
              Thanks for subscribing! You're all set to receive our updates.
            </p>
          </div>
        ) : (
